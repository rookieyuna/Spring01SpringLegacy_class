...
public class ServiceController {
	...
	이때 컨트롤러가 받은 모든 요청(request 객체)을 전달한다.
	 */
	...
	/*
	사용자가 HTML 페이지에서 각 링크를 클릭할 때 전달하는 userLottoNum 파라미터를
	lottoVO객체가 받아서 사용한다.
	 */
	...
	public String myLotto(LottoVO lottoVO, Model model) {
		 ...
		 */
		lottoVO = lottoService.getLottoProcess(
				lottoVO.getUserLottoNum(), lottoVO);
